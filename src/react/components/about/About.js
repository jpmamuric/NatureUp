    ...
    <section className='section-about' id='about'>
      ...
      <div className='row'>
        <div className='col-1-of-2'>
          <h3 className='heading-tertiary util-margin-bottom-small'> You're going to fall in love with nature </h3>
          ...
          <h3 className='heading-tertiary  util-margin-bottom-small'> Live adventurous like you never have before </h3>
          <p className='paragraph'>
